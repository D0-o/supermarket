...
CREATE TABLE `cashier_configure`  (
  ...
  `json` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '配置json',
...
CREATE TABLE `cashier_goods`  (
  ...
  `salesPrice` decimal(5, 2) NULL DEFAULT NULL COMMENT '零售价',
  `purchasePrice` decimal(5, 2) NULL DEFAULT NULL COMMENT '购买价',
...
-- ----------------------------
INSERT INTO `cashier_goods` VALUES (1, '苹果', 'ZDY1644545950057', 1.00, 1.00, 1, 1086, '', 2, '2022-02-11', 11, 1, 0.00, '', '2022-02-11 10:19:45', '2022-03-14 16:19:52', 1, 'admin', 1);
...
CREATE TABLE `cashier_goods_history`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT,
  `goodsCode` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '商品编号',
  `goodsName` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '商品名称',
  `inventory` int(0) NULL DEFAULT NULL COMMENT '库存',
...
CREATE TABLE `cashier_in_goods`  (
  ...
  `goodsName` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '商品名称',
  `goodsCode` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '商品编号',
  `salesPrice` decimal(5, 2) NULL DEFAULT NULL COMMENT '零售价格',
  `purchasePrice` decimal(5, 2) NULL DEFAULT NULL COMMENT '购买价格',
  `type` int(0) NULL DEFAULT NULL COMMENT '类型',
  `inventory` int(0) NULL DEFAULT NULL COMMENT '库存',
  `supplier` int(0) NULL DEFAULT NULL COMMENT '供货商',
  `productionPeriod` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '生产期',
  `shelfLife` int(0) NULL DEFAULT NULL COMMENT '保质期',
  `batch` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '批次',
  `status` int(0) NULL DEFAULT NULL COMMENT '状态',
  ...
  `parentId` bigint(0) NULL DEFAULT NULL COMMENT '父级id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '进货表' ROW_FORMAT = Dynamic;
...
INSERT INTO `cashier_in_goods` VALUES (6, '苹果', 'ZDY1644545950057', 1.00, 1.00, 1, 1, 2, '2022-02-11', 11, '1647245975702', 1, '2022-03-14 16:19:52', 1, 'admin', 1);
...
CREATE TABLE `cashier_inventory`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT,
  `inventoryNo` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '库存编号',
  `inventoryTime` date NULL DEFAULT NULL COMMENT '库存时间',
  `beforeInventory` int(0) NULL DEFAULT NULL COMMENT '之前库存数',
  `afterInventory` int(0) NULL DEFAULT NULL COMMENT '之后库存数',
  `difference` int(0) NULL DEFAULT NULL COMMENT '差异个数',
  `status` int(0) NULL DEFAULT NULL COMMENT '状态',
  `ramerk` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '备注',
  `createTime` timestamp(0) NULL DEFAULT NULL COMMENT '创建时间',
  `uid` bigint(0) NULL DEFAULT NULL COMMENT '用户id',
...
CREATE TABLE `cashier_inventory_day`  (
  ...
  `goodsCode` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '商品编号',
  `goodsName` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '商品名称',
  `purchasePrice` decimal(5, 2) NULL DEFAULT NULL COMMENT '销售价格',
  `beforeInventory` int(0) NULL DEFAULT NULL COMMENT '之前库存数',
  `afterInventory` int(0) NULL DEFAULT NULL COMMENT '之后库存数',
  `createTime` timestamp(0) NULL DEFAULT NULL COMMENT '创建时间',
  `parentId` bigint(0) NULL DEFAULT NULL COMMENT '父级id',
  `inInventory` int(0) NULL DEFAULT NULL COMMENT '库存',
  `payNum` int(0) NULL DEFAULT NULL COMMENT '销售个数',
  `reportLoss` int(0) NULL DEFAULT NULL COMMENT '损坏个数',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 149 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '每天库存表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of cashier_inventory_day
-- ----------------------------
INSERT INTO `cashier_inventory_day` VALUES (106, '2022-02-18', 'ZDY1644545950057', '苹果', 1.00, 1111, 1111, '2022-02-18 23:52:18', 1, 1, 0, 0);
...
INSERT INTO `cashier_inventory_day` VALUES (116, '2022-02-19', 'ZDY1644545950057', '苹果', 1.00, 111, 1111, '2022-02-19 00:05:08', 1, 0, 0, 0);
...
INSERT INTO `cashier_inventory_day` VALUES (119, '2022-02-19', 'ZDY1644545950057', '苹果', 1.00, 1111, 1111, '2022-02-19 00:05:08', 1, 0, 0, 0);
...
INSERT INTO `cashier_inventory_day` VALUES (123, '2022-02-19', 'ZDY1644545950057', '苹果', 1.00, 1083, 1083, '2022-02-19 16:12:14', 1, 0, 0, 0);
...
INSERT INTO `cashier_inventory_day` VALUES (126, '2022-02-19', 'ZDY1644545950057', '苹果', 1.00, 1099, 1099, '2022-02-19 23:34:36', 2, 10, 0, 0);
...
INSERT INTO `cashier_inventory_day` VALUES (135, '2022-03-14', '1', '全聚德', 32.00, 3, 3, '2022-03-14 16:41:14', 2, 0, 0, 0);
INSERT INTO `cashier_inventory_day` VALUES (142, '2022-03-14', '1', '全聚德', 32.00, 3, 3, '2022-03-14 16:42:22', 2, 0, 0, 0);
INSERT INTO `cashier_inventory_day` VALUES (143, '2022-03-14', 'ZDY1644545950057', '苹果', 1.00, 111, 1086, '2022-03-14 16:42:38', 1, 1, 0, 0);
INSERT INTO `cashier_inventory_day` VALUES (144, '2022-03-14', 'ZDY1644545950057', '苹果', 1.00, 1111, 1086, '2022-03-14 16:42:38', 1, 1, 0, 0);
INSERT INTO `cashier_inventory_day` VALUES (145, '2022-03-14', 'ZDY1644550775884', '梨', 1.00, 12, 12, '2022-03-14 16:42:38', 1, 0, 0, 0);
INSERT INTO `cashier_inventory_day` VALUES (146, '2022-03-14', 'ZDY1644568609024', '橘子', 2.00, 1111, 1111, '2022-03-14 16:42:38', 1, 0, 0, 0);
INSERT INTO `cashier_inventory_day` VALUES (147, '2022-03-14', 'ZDY1644550775884', '梨', 1.00, 12, 12, '2022-03-14 16:42:38', 1, 0, 0, 0);
INSERT INTO `cashier_inventory_day` VALUES (148, '2022-03-14', 'ZDY1644568609024', '橘子', 2.00, 1111, 1111, '2022-03-14 16:42:38', 1, 0, 0, 0);
INSERT INTO `cashier_inventory_day` VALUES (149, '2022-03-14', '1', '全聚德', 32.00, 3, 3, '2022-03-14 16:42:38', 2, 0, 0, 0);
...
CREATE TABLE `cashier_inventory_goods`  (
  ...
  `goodsName` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '商品名称',
  `goodsCode` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '商品编号',
  `purchasePrice` decimal(5, 2) NULL DEFAULT NULL COMMENT '商品单价',
  `type` int(0) NULL DEFAULT NULL COMMENT '类型',
  `beforeInventory` int(0) NULL DEFAULT NULL COMMENT '之前库存数',
  `afterInventory` int(0) NULL DEFAULT NULL COMMENT '更新库存数',
  `difference` int(0) NULL DEFAULT NULL COMMENT '差异数',
  `createTime` timestamp(0) NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 89 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '库存商品数' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cashier_loss_goods`  (
  ...
  `goodsName` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '商品名称',
  `goodsCode` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '商品编码',
  `purchasePrice` decimal(5, 2) NULL DEFAULT NULL COMMENT '商品价格',
  `type` int(0) NULL DEFAULT NULL COMMENT '类型',
  `reportLoss` int(0) NULL DEFAULT NULL COMMENT '损坏个数',
  `ramerk` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '备注',
  `createTime` timestamp(0) NULL DEFAULT NULL COMMENT '创建时间',
  ...
  `parentId` bigint(0) NULL DEFAULT NULL COMMENT '父级id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '商品损坏表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cashier_menu`  (
  ...
  `menuUrl` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '菜单路径',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '目录' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cashier_order`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT,
  `orderId` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '订单编号',
  `amount` decimal(5, 2) NULL DEFAULT NULL COMMENT '总额',
  `fictitious` decimal(5, 2) NULL DEFAULT NULL COMMENT '折扣',
  `actualPay` decimal(5, 2) NULL DEFAULT NULL COMMENT '实际支付',
  `num` int(0) NULL DEFAULT NULL COMMENT '购买数量',
  `singleNum` int(0) NULL DEFAULT NULL COMMENT '商品数量',
  `status` int(0) NULL DEFAULT NULL COMMENT '状态',
  `unfinished` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '商品*数量',
  ...
  `giveChange` decimal(5, 2) NULL DEFAULT NULL COMMENT '找零',
  `payType` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '支付类型',
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `cashier_order` VALUES (34, 'SY1647245830080', 1.00, 0.00, 1.00, 1, 1, 0, '苹果*1', '2022-03-14 16:17:10', '2022-03-14 16:17:10', NULL, 1, 'admin', 1, NULL, NULL);
...
CREATE TABLE `cashier_order_goods`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT,
  `orderId` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '订单号',
  `goodsCode` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '商品编码',
  `goodsName` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '商品名称',
  `num` int(0) NULL DEFAULT NULL COMMENT '数量',
  `costPrice` decimal(5, 2) NULL DEFAULT NULL COMMENT '零售价',
  `discount` decimal(5, 2) NULL DEFAULT NULL COMMENT '折扣',
  `currentPrice` decimal(5, 2) NULL DEFAULT NULL COMMENT '当前售价',
  `type` int(0) NULL DEFAULT NULL COMMENT '类型',
  `subtotal` decimal(5, 2) NULL DEFAULT NULL COMMENT '支付金额',
  `createTime` timestamp(0) NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 34 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '支付商品表' ROW_FORMAT = Dynamic;
...
INSERT INTO `cashier_order_goods` VALUES (34, 'SY1647245830080', 'ZDY1644545950057', '苹果', 1, 1.00, 0.00, 1.00, 1, 1.00, '2022-03-14 16:17:10');
...
CREATE TABLE `cashier_pay_type`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT,
  `type` int(0) NULL DEFAULT NULL COMMENT '类型',
  `acct` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '账号',
  ...
  `updateTime` timestamp(0) NULL DEFAULT NULL COMMENT '更新时间',
  `uid` bigint(0) NULL DEFAULT NULL COMMENT '用户id',
  `uname` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '用户名字',
  `parentId` bigint(0) NULL DEFAULT NULL COMMENT '父级Id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 315104422090598 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '支付金额类型' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of cashier_pay_type
-- ----------------------------
INSERT INTO `cashier_pay_type` VALUES (315104422090598, 1, '123123', '123.00', '123.jpg', NULL, '2022-03-15 10:44:22', 1, 'admin', 1);
...
CREATE TABLE `cashier_user`  (
  ...
  `createTime` timestamp(0) NULL DEFAULT NULL COMMENT '创建时间',
  `updateTime` timestamp(0) NULL DEFAULT NULL COMMENT '更新时间',
  `loginTime` timestamp(0) NULL DEFAULT NULL COMMENT '登录时间',
  `parentId` bigint(0) NULL DEFAULT NULL COMMENT '父级Id',
  `createId` bigint(0) NULL DEFAULT NULL COMMENT '创建人id',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `cashier_user` VALUES (1, 'admin', '123', 1, '2022-02-11 10:56:40', NULL, '2022-03-16 13:10:55', 1, 1);
INSERT INTO `cashier_user` VALUES (2, '00001', '123', 2, '2022-02-11 10:56:40', NULL, '2022-03-15 09:40:17', 2, 1);
INSERT INTO `cashier_user` VALUES (3, '00002', '123', 3, '2022-02-19 14:54:52', NULL, '2022-03-14 18:36:34', 2, 2);
